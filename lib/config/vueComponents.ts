...
import AdvancedCounter from '../../src/components/examples/AdvancedCounter.vue';
...
export const lazyVueComponentRegistry: LazyComponentConfig[] = [
  ...
  //   name: 'PhotoGallery',
  //   loader: () => import('../../src/components/gallery/PhotoGallery.vue'),
  ...
  //   loader: () => import('../../src/components/analytics/Dashboard.vue'),
